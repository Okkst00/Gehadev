    ...
    <div class="container dlt">
        <div class="row justify-content-center align-items-center">
            <div class="col col-lg-6">
                <h4 class="mb-5 text-center">Apakah kamu yakin ingin hapus Harga ini : <strong>{{ $priceList->id_harga }}</strong> ?</h4>
                <div class="btns text-center">
                    <form action="/admin/destroy-price/{{ $priceList->id }}" method="post" class="d-inline-block">
                        @csrf
                        @method('delete')
                    ...
                    <a href="/admin/input-price" class="btn btn-success text-center px-5 py-2 rounded-5 shadow ms-lg-3 ms-md-3 ms-2"><i class="bi bi-x-circle-fill"></i> Batalkan</a>
                </div>
            </div>
        </div>
    </div>
