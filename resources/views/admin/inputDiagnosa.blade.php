        ...
        <div class="col-lg-2 side-bars  mb-4 sticky-top">
            ...
            <div class="card border-0 mt-5">
                <ul class="list-unstyled">
                    ...
                    <li class="py-2 mb-2">
                        <a href="/admin/penyakit" class="ps-3 side-txt active"><i class="bi bi-tags"></i> Input Diagnosa</a>
                    </li>
                    <li class="py-2 mb-2">
        ...
        <div class="col-lg-10 mb-4 main-section">
            <nav class="navbar navbar-expand-lg bg-light mb-4"  data-aos="fade-up">
                <div class="container-fluid">
                  <a class="navbar-brand" href="#">Input Diagnosa</a>
                ...
                <div class="col col-lg-11">
                    ...
                    <table class="table mt-4">
                        ...
                        <tr>
                            ...
                            <td scope="col" class="fw-bold">Nama Penyakit</td>
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Jenis Diagnosa</h1>
                            ...
                            <div class="modal-body">
                                <form method="POST" id="form_upload">
                                    ...
                                    <button type="submit" class="btn btn-success mt-5 px-5 rounded-5 y">Submit</button>
                                </form>
                            </div>
                        </div>
                        </div>
...
<script>
  ...
  document.querySelector("#form_upload").addEventListener('submit',function(e){
    ...
    //  jika ada value id, maka ubah method nya ke PUT
    if(formData.get('id')){ 
