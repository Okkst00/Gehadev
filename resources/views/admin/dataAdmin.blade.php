...
<head>
    ...
    <title>Input Diagnosa Tier | GehaMin'</title>
...
* {
  ...
  .container .main-contents .main-mess .col .card .btn-group .edit {
  ...
  .container .main-contents .main-mess .col .card .btn-group .edit:hover {
    opacity: .8;
  }
  
  .container .main-contents .main-mess .col .card .btn-group .delete {
  ...
  .container .main-contents .main-mess .col .card .btn-group .delete:hover {
    opacity: .8;
  }

  .container .main-contents .main-mess .col .card .text-muted {
    font-size: 13px;
  }
        ...
        <div class="col-lg-2 side-bars  mb-4 sticky-top">
            ...
            <div class="card border-0 mt-5">
              <ul class="list-unstyled">
                ...
                <li class="py-2 mb-2">
                    <a href="/admin/admin" class="ps-3 side-txt active"><i class="bi bi-headset"></i> Data Admin</a>
                </li>
                <li class="py-2 mb-2">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputEmail1" name="email" autocomplete="off">
