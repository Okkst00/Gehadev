...
<div class="container mt-3" >
    <div class="row">
        <div class="col-lg-2 side-bars  mb-4 sticky-top">
            ...
            <div class="card border-0 mt-5">
                <ul class="list-unstyled">
                    <li class="py-2 mb-2">
                        <a href="/admin/dashboard" class="ps-lg-3 ps-md-4 ps-3 side-txt active"><i class="bi bi-speedometer2"></i> Dashboard</a>
                    </li>
                    <li class="py-2 mb-2">
        ...
        <div class="main-section col-lg-10 mb-4">
            ...
            <div class="offcanvas offcanvas-start side-mob" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
              ...
              <div class="offcanvas-body">
                  <img src={{ '../assets/img/8056.jpg' }} class="img-fluid rounded-circle shadow d-flex mx-auto mt-4" alt="">
                  <div class="headtext text-center mt-3 text-white"><i class="bi bi-headset"></i></div>
            ...
            <div class="row">
                <div class="col col-lg-4 col-md-6 col-12">
                    <div class="card w-100 text-bg-success mb-3">
                ...
                <div class="col col-lg-4 col-md-6 col-12">
                    <div class="card w-100 text-bg-success mb-3" >
                      ...
                      <div class="card-body">
                          <div class="d-flex justify-content-between align-items-center">
                              <h1 class="p">{{$data['jml_artikel']}}</h1>
                              <i class="bi bi-file-earmark-post" style="font-size: 50px"></i>
                            </div>
                      </div>
                    </div>
                </div>
                <div class="col col-lg-4 col-md-6 col-12">
                    <div class="card w-100 text-bg-success mb-3">
                      <div class="card-header">Data Knowledge</div>
                      <div class="card-body">
                          <div class="d-flex justify-content-between align-items-center">
                              <h1 class="p">{{$data['jml_knowledge']}}</h1>
