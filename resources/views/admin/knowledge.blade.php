        ...
        <div class="col-lg-2 side-bars  mb-4 sticky-top">
            ...
            <div class="card border-0 mt-5">
                <ul class="list-unstyled">
                    ...
                    <li class="py-2 mb-2">
                        <a href="/admin/knowledge" class="ps-lg-3 ps-md-4 ps-3 side-txt active"><i class="bi bi-book"></i> Knowledge</a>
                    </li>
                    <li class="py-2 mb-2">
        ...
        <div class="col-lg-10 mb-4 main-section">
                                    ...
                                    <div class="text-center col-lg-12 mt-4">
                                        <form action="" method="post" enctype="multipart/form-data"> 
                                            ...
                                            <div class="form-group">
                                                <textarea class="form-control mb-3" rows="2" name="title" placeholder="Judul"></textarea>
                                            </div>
                                            <div class="form-group mb-5">
                                                <textarea class="form-control mb-5" rows="10" name="content" id="content" placeholder="Isi"></textarea>
                                            </div>
            ...
            <div class="row justify-content-center">
                <div class="articles pb-5 pt-2">
                    <div class="container">
                        <h2 class="text-center mt-5" style="font-weight: bold;">knowledge</h2>
                        <div class="row justify-content-center">
                                    ...
                                    <div class="card  border-0 shadow">
                                        ...
                                        <div class="card-body p-3">
                                            ...
                                            <div class="d-flex justify-content-end pt-4">
                                                <div class="btn-group">
                                                    <a href="/admin/edit-std_knowledge/{{ $data->id }}" class="px-3 py-2 edit me-2 shadow-sm"><i class="bi bi-pen-fill"></i> Edit </a>
                                                    <form action="/admin/delete-std_knowledge/{{ $data->id }}" method="post" class=" text-center">
                                                        @csrf
                                                        @method('delete')
